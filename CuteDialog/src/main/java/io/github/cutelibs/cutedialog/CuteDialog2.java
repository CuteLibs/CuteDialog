...
public class CuteDialog2 extends Dialog {
    ...
    public CuteDialog2(Context context) {
        super(context);
    ...
    public CuteDialog2 setDialogStyle(int bgColor, int cornerRadius, int dialogPosition, int padding) {
    ...
    public CuteDialog2 isCancelable(boolean cancelable) {
    ...
    public CuteDialog2 setHeader(int chooser) {
    ...
    public CuteDialog2 setHeaderIcon(int icon) {
        try {
    ...
    public CuteDialog2 setHeaderImage(int image) {
        try {
    ...
    public CuteDialog2 setHeaderAnimation(int animation) {
        try {
    ...
    public CuteDialog2 setNegativeButtonListener(View.OnClickListener listener) {
    ...
    public CuteDialog2 setCloseListener(View.OnClickListener listener) {
