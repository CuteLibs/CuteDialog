...
import io.github.cutelibs.cutedialog.CuteDialog2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.design1.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_ICON)
                .setHeaderIcon(R.drawable.icon_1)
                .setTitle("Wrong Time", 0, 0, 0)
                .setDesc("You can't do this right now.\nTry Later", 0, 0, 0)
                .show());

        binding.design2.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_IMAGE)
                .setHeaderImage(R.drawable.image_1)
                .setTitle("Take a break", 0, 0, 0)
                .setDesc("Isn't it a great time to go for a walk?", 0, 0, 0)
                .show());

        binding.design3.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_ANIMATION)
                .setHeaderAnimation(R.raw.anim1)
                .setTitle("Set Reminder", 0, 0, 0)
                .setDesc("Do you want me to remind you? ", 0, 0, 0)
                .show());

        binding.design4.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_IMAGE)
        ...
        binding.design5.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_ANIMATION)
        ...
        binding.design6.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_ANIMATION)
        ...
        binding.design7.setOnClickListener(v -> new CuteDialog2(this)
                .setDialogStyle(Color.WHITE, 10, CuteDialog2.POSITION_CENTER, 10)
                .isCancelable(true)
        ...
        binding.design8.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_IMAGE)
        ...
        binding.design9.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_ICON)
        ...
        binding.design10.setOnClickListener(v -> new CuteDialog2(this)
                .setHeader(CuteDialog2.HEADER_ANIMATION)
